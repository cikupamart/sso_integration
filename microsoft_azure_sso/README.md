# Microsoft Azure SSO Integration (Odoo 18)
...
```
microsoft_azure_sso/
├── controllers/main.py        # OAuth2 login & callback endpoints
├── models/res_config_settings.py
├── models/res_users.py        # Azure identity fields + one-time SSO token auth
├── models/sso_audit_log.py    # Audit log model
├── security/                  # Groups, record rules, access rights
├── views/                     # Settings, audit log, dashboard action, menus, login button
